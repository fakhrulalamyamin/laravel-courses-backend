...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('courses', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('resources')->default(0)->comment('book or course count');
            ...
            $table->unsignedBigInteger('difficulty_label')->default(0)->comment('0=Beginner, 1=Intermediate, 2=Advance');
