<x-guest-layout>
    ...
    <div class="container">
        ...
        <form action="" class="mt-20">
            <div class="w-full relative max-w-[860px] mx-auto px-5 pb-[138px] pt-24">
                ...
                <!--hero icon-->
                <img src="{{ asset('img/left-top-angle.png') }}" alt="angle" class="absolute pointer-events-none top-[150px] -left-28">
                <img src="{{ asset('img/left-bottom-angle.png') }}" alt="angle" class="absolute  pointer-events-none top-[370px] -left-12">
                <img src="{{ asset('img/right-angle.png') }}" alt="angle" class="absolute pointer-events-none top-[70px] -right-6">
                <img src="{{ asset('img/right-bottom-angle.png') }}" alt="angle" class="absolute   pointer-events-none top-[360px] -right-24">
          </div>
        </form>
    ...
    {{-- Featured Section --}}
    <section class="container mt-20 lg:mt-[140px]">
