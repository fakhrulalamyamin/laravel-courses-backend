                ...
                <div class="flex h-16 justify-between items-center">
                    <div class="flex items-center">
                        ...
                        <nav class="hidden h-16 space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <a href="{{ route('courses') }}" class="inline-flex items-center px-1 pt-1 border-b-2 border-transparent text-base font-medium leading-5 text-gray-500 hover:text-gray-700 hover:border-gray-300 focus:outline-none focus:text-gray-700 focus:border-gray-300 transition">Books</a>
                        </nav>
                    </div>
                    ...
                    <div class="flex items-center">
                        @if (Auth::check())
                            ...
                            @else
                                ...
                                <a href="#" class="ml-8 inline-flex items-center justify-center rounded border border-transparent bg-black px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-red-500">Add New Course</a>
            ...
            <div class="container flex justify-between pb-[50px]">
              <div>
                ...
                <ul class="mt-5">
                  ...
                  <li class="mb-2">
                    <a href="{{ route('archive', ['series', 'alpinejs']) }}" class="text-links text-gray-100 text-base before:text-gray-100">AlpineJs</a>
                  </li>
                </ul>
              </div>
              <div>
              ...
              <div>
                ...
                <ul class="mt-5">
                  ...
                  <li class="mb-2">
                    <a href="{{ route('archive', ['level', 'advance']) }}" class="text-links text-gray-100 text-base before:text-gray-100">Advanced</a>
                  </li>
                </ul>
              </div>
              <div>
                ...
                <ul class="mt-5">
                    <li class="mb-2">
                        <a href="{{ route('archive', ['platform', 'shikhun.net']) }}" class="text-links text-gray-100 text-base before:text-gray-100">Shikun.net</a>
                    </li>
                  <li class="mb-2">
                  ...
                  <li class="mb-2">
                    <a href="{{ route('archive', ['platform', 'laravel-courses']) }}" class="text-links text-gray-100 text-base before:text-gray-100">Laravel Courses</a>
                  </li>
                </ul>
              </div>
              <div>
