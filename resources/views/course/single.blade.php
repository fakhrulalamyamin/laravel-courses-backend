            ...
            <div class="flex mt-8">
                ...
                <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                    ...
                    @if (count($course->reviews) > 0)
                        <div class="mt-2 bg-white rounded-sm shadow p-6">
                            @foreach ($course->reviews as $review)
                                <div class="bg-white border border-gray-300 rounded-sm p-6 mb-3">
                                    <p class="mb-3">{{ $review->comment }}</p>
                                    <h3 class="font-bold "> — {{ $review->users->name }}</h3>
                                </div>
                            @endforeach
                        </div>
                    @else
                            ...
                            @foreach ($course->authors as $author)
                                <div class="space-y-4 pb-2">
                                    ...
                                    <ul role="list" class="flex space-x-5 justify-center">
                                        ...
                                        <li>
                                            <a href="{{ $author->webUrl }}" class="text-gray-400 hover:text-gray-500"
                                                target="_blank">
